...
class TriggerDispatch:
    def __init__(self, mcu):
        ...
        try:
            ...
            logging.info("TriggerDispatch: Fixed timeout mode (default) for MCU '%s': %s", self._mcu_name, str(e))
    def get_oid(self):
    ...
    def start(self, print_time):
        ...
        if self._adaptive_timeout is not None:
            ...
            logging.info("TriggerDispatch: Using adaptive timeout %.6f for MCU '%s'", expire_timeout, self._mcu_name)
        else:
